...
list2step = [
    FeatureMapInfo(id="ws1-2", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws3-4", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws5-6", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws7-8", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws9-10", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws11-12", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws13-14", active=True, track_name="drums", feature_name="rms", factor=1),
    FeatureMapInfo(id="ws15-16", active=True, track_name="drums", feature_name="rms", factor=1)]
